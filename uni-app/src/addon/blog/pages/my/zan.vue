...
<script setup lang="ts">
	...
	import { getCategory, getBanner, getTielistZan, getTongji,delTieApi,getConfigApi } from '@/addon/blog/api/tie'
	...
	const getListFn = (mescroll : mescrollStructure) => {
		...
		getTielistZan(data).then((res : any) => {
