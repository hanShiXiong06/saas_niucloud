<template>
	<view class="min-h-screen bg-gray-50 w-full" :style="themeColor()" v-if="memberStore.info">
		...
		<share-poster ref="sharePosterRef" posterType="ai_humans_poster" :posterId="poster_id"
			:posterParam="posterParam" :copyUrlParam="copyUrlParam" :copyUrl="'/addon/ai_humans/pages/index/index'" />
...
import {
	getFenxiaoInfo, getFenxiaoMember
