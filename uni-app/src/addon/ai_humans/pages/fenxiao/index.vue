<template>
		...
		<view class="bgcontent p-4">
			<view class="flex justify-between items-center mb-4">
				...
				<view
					...
					@click="shareEvent()">
					<u-icon :name="img('addon/ai_humans/fenxiao/tgm.png')" size="20"></u-icon>
			...
			<view class="bg-gradient-to-br from-[#2F302B] to-[#3a3b35] p-5 rounded-[16rpx] shadow-lg"
				:style="{ ...headerStyle, backgroundImage: 'url(' + img('addon/ai_humans/fenxiao/bjtt.png') + ')' }">
		...
		<view class="mx-4 mt-4" v-if="fenxiaoinfo">
			<view class="bg-white rounded-[16rpx] p-4 shadow-sm mb-4 hover:shadow-md transition-all duration-300">
				<view class="flex items-center justify-between mb-6">
					...
					<view class="flex items-center cursor-pointer"
						@click="redirect({ url: '/addon/ai_humans/pages/fenxiao/member' })">
			...
			<view class="bg-white rounded-[16rpx] p-4 mb-4 shadow-sm hover:shadow-md transition-all duration-300">
				<view class="flex items-center justify-between mb-6">
					...
					<view class="flex items-center cursor-pointer"
						@click="redirect({ url: '/addon/ai_humans/pages/fenxiao/order' })">
	...
	<share-poster ref="sharePosterRef" posterType="ai_humans_poster" :posterId="poster_id" :posterParam="posterParam"
		:copyUrlParam="copyUrlParam" :copyUrl="'/addon/ai_humans/pages/index/index'" />
...
import {
	getFenxiaoInfo
} from '@/addon/ai_humans/api/fenxiao'
import { useLogin } from '@/hooks/useLogin'
import { authLogin } from "@/addon/ai_humans/utils/ts/common";
authLogin()
// 提现
const applyCashOut = () => {
