        ...
        <view class="status-card">
            ...
            <view class="status-content">
                ...
                <view class="status-header">
                    ...
                    <view class="status-badge" :class="orderInfo.status_name">
                ...
                <view class="order-info">
                    ...
                    <view class="info-row">
                        ...
                        <text class="value">{{ orderInfo?.member?.nickname || '未录入' }}</text>
                    </view>
                    <view class="info-row">
                        <view class="label">
                        ...
                        <text class="value">{{ orderInfo?.member?.mobile || '未录入' }}</text>
                    </view>
                    <view class="info-row">
                        <view class="label">
...
const hasUnconfirmedDevices = computed(() => {
    return orderInfo.value?.devices?.some(device => device.status == '4') || false
})
...
const showDeviceActions = (status: DeviceStatus): boolean => {
    return status == '4' // 只有在已质检状态下才显示操作按钮
}
