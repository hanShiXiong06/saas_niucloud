	...
	<view class="bg-[#F6F6F6] min-h-[100vh] w-full" :style="themeColor()" v-if="memberStore.info">
		<view class="reseller fixed w-full z-2 !bg-[#F6F6F6]">
			<view class="top mt-[-44rpx]"
				:style="{ ...headerStyle, backgroundImage: 'url(' + img('addon/hk/fenxiao/bjfx.png') + ')' }">
				...
				<view class="top1">
					...
					<view class="fx" @click="shareEvent()">
						<image class="icon1" :src="img('addon/hk/fenxiao/fenxiang.png')" mode="aspectFit">
						</image>
				...
				<view class="tixian" @click="applyCashOut()">
			...
			<view v-if="fenxiaoinfo" class="icon">
				<view class="ico">
					<view class="tubiao">
						<image class="img" :src="img('addon/hk/fenxiao/yifx.png')"></image>
					</view>
					<view class="tt">
				...
				<view class="ico">
					<view class="tubiao">
						<image class="img" :src="img('addon/hk/fenxiao/fxtd.png')"></image>
					</view>
					<view class="tt">
				...
				<view class="ico">
					<view class="tubiao">
						<image class="img" :src="img('addon/hk/fenxiao/yidd.png')"></image>
					</view>
					<view class="tt">
				...
				<view class="ico">
					<view class="tubiao">
						<image class="img" :src="img('addon/hk/fenxiao/erdd.png')"></image>
					</view>
					<view class="tt">
