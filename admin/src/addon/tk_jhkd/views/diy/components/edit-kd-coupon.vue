		...
		<div class="edit-attr-item-wrap">
			...
			<el-form label-width="80px" class="px-[10px]">
				<el-form-item :label="t('selectStyle')" class="flex">
					<span class="text-primary flex-1 cursor-pointer" @click="showCouponStyle">{{
		...
		<div class="edit-attr-item-wrap">
			...
			<el-form label-width="90px" class="px-[10px]">
				...
				<el-form-item :label="t('couponTitle')">
					<el-input v-model.trim="diyStore.editComponent.couponTitle" clearable
						:maxlength="diyStore.editComponent.style == 'style-3' ? 4 : 8" show-word-limit />
				</el-form-item>

				<el-form-item :label="t('couponSubTitle')">
					<el-input v-model.trim="diyStore.editComponent.couponSubTitle" clearable
						:maxlength="diyStore.editComponent.style == 'style-3' ? 7 : 10" show-word-limit />
				</el-form-item>
		...
		<div class="edit-attr-item-wrap">
			...
			<el-form label-width="90px" class="px-[10px]">
				...
				<el-form-item :label="t('manualSelectionSources')" v-if="diyStore.editComponent.source == 'custom'">
					<coupon-select-popup ref="couponSelectPopupRef" v-model="diyStore.editComponent.couponIds" :min="1"
						:max="20" />
				</el-form-item>
		...
		<div class="edit-attr-item-wrap" v-if="diyStore.editComponent.style == 'style-4'">
			...
			<el-form label-width="90px" class="px-[10px]">
				...
				<el-form-item :label="t('couponSubTitleColor')">
					<el-color-picker v-model="diyStore.editComponent.subTitleColor" show-alpha
						:predefine="diyStore.predefineColors" />
				</el-form-item>
			</el-form>
		</div>
		...
		<div class="edit-attr-item-wrap" v-if="diyStore.editComponent.style == 'style-4'">
			...
			<el-form label-width="90px" class="px-[10px]">
				<el-form-item :label="t('couponMoney')">
					<el-color-picker v-model="diyStore.editComponent.couponItem.moneyColor" show-alpha
						:predefine="diyStore.predefineColors" />
				</el-form-item>
				<el-form-item :label="t('textColor')">
					<el-color-picker v-model="diyStore.editComponent.couponItem.textColor" show-alpha
						:predefine="diyStore.predefineColors" />
				</el-form-item>
				<el-form-item :label="t('subTextColor')">
					<el-color-picker v-model="diyStore.editComponent.couponItem.subTextColor" show-alpha
						:predefine="diyStore.predefineColors" />
				</el-form-item>
				<el-form-item :label="t('listFrameColor')">
					<el-color-picker v-model="diyStore.editComponent.couponItem.bgColor" show-alpha
						:predefine="diyStore.predefineColors" />
				</el-form-item>
				<el-form-item :label="t('goodsRounded')">
					<el-slider v-model="diyStore.editComponent.couponItem.aroundRadius" show-input size="small"
...
import couponSelectPopup from '@/addon/tk_jhkd/views/coupon/components/coupon-select-popup.vue'
...
const couponStyleList = reactive([
	{
		url: 'addon/tk_jhkd/diy/coupon/style-1.png',
		title: '风格1',
		value: 'style-1'
	},
	{
		url: 'addon/tk_jhkd/diy/coupon/style-2.png',
		title: '风格2',
		value: 'style-2'
	},
	// {
	// 	url: 'addon/tk_jhkd/diy/coupon/style-3.png',
	// 	title: '风格3',
	// 	value: 'style-3'
	// },
	{
		url: 'addon/tk_jhkd/diy/coupon/style-4.png',
		title: '风格3',
		value: 'style-4'
	}
])
