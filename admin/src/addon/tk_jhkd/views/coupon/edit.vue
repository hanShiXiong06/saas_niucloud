<template>
    <div class="main-container">
        ...
        <!-- 表单 -->
        <el-card class="box-card mt-[15px] !border-none " shadow="never" v-if="Object.keys(formData).length"
            v-loading="loading">
            <el-form class="page-form" :model="formData" label-width="120px" ref="formRef" :rules="formRules">
                ...
                <el-form-item :label="t('price')" prop="price">
                    <el-input v-model.trim="formData.price" @keyup="filterDigit($event)" clearable
                        :placeholder="t('pricePlaceholder')" class="input-width" maxlength="5" />
                </el-form-item>
                ...
                <el-form-item v-if="formData.type == 3" prop="goods_ids">
                    <div>
                        <el-form-item>
                            <goods-select-popup ref="goodsSelectPopupRef" v-model="formData.goods_ids" :min="1"
                                :max="99" />
                        </el-form-item>
                    </div>
                </el-form-item> -->
                ...
                <el-form-item v-if="formData.threshold == 1" prop="min_condition_money">
                    ...
                    <div class="flex items-center px-[5px]">
                        <el-input v-model.trim="formData.min_condition_money" @keyup="filterDigit($event)" clearable
                            class="!w-[100px]" />
                    </div>
                    元可用
                </el-form-item>
                ...
                <el-form-item v-show="formData.valid_type == 1">
                    领劵后立即生效，有效期
                    <div class="flex items-center px-[5px]">
                        <el-input v-model.trim="formData.length" @keyup="filterNumber($event)" clearable
                            class="!w-[100px]" />
                    </div>
                    天
                </el-form-item>
...
import { editCoupon, getCouponInfo } from '@/addon/tk_jhkd/api/coupon'
