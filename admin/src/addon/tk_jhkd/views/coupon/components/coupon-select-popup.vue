<template>
    <div>
        ...
        <el-dialog v-model="showDialog" :title="t('优惠券选择')" width="1000px" :close-on-press-escape="false"
            ...
            <el-form :inline="true" :model="couponTable.searchParam" ref="searchFormRef">
                <el-form-item :label="t('优惠券名称')" prop="keyword" class="form-item-wrap">
                    <el-input v-model.trim="couponTable.searchParam.title" :placeholder="t('请输入优惠券名称')"
                        maxlength="60" />
                </el-form-item>
            ...
            <el-table :data="couponTable.data" size="large" v-loading="couponTable.loading" ref="couponListTableRef"
...
import { getCouponSelectList } from '@/addon/tk_jhkd/api/coupon'
