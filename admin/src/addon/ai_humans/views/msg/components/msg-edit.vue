<template>
    <el-dialog v-model="showDialog" :title="formData.id ? t('updateMsg') : t('addMsg')" width="50%" class="diy-dialog-wrap" :destroy-on-close="true">
        <el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form" v-loading="loading">
                ...
                <el-form-item :label="t('modelId')" >
                    <el-input v-model="formData.model_id" clearable :placeholder="t('modelIdPlaceholder')" class="input-width" />
                </el-form-item>
                
                <el-form-item :label="t('msgId')" >
                    <el-input v-model="formData.msg_id" clearable :placeholder="t('msgIdPlaceholder')" class="input-width" />
                </el-form-item>
                
                <el-form-item :label="t('role')" >
                    <el-input v-model="formData.role" clearable :placeholder="t('rolePlaceholder')" class="input-width" />
                </el-form-item>
                ...
                <el-form-item :label="t('isNew')" >
                    <el-input v-model="formData.is_new" clearable :placeholder="t('isNewPlaceholder')" class="input-width" />
                </el-form-item>
                ...
                <el-form-item :label="t('token')" >
                    <el-input v-model="formData.token" clearable :placeholder="t('tokenPlaceholder')" class="input-width" />
                </el-form-item>
...
import { addMsg, editMsg, getMsgInfo, getWithMemberList } from '@/addon/ai_humans/api/msg'
...
,
    msg_id: [
        { required: true, message: t('msgIdPlaceholder'), trigger: 'blur' },
        
    ]
,
    role: [
        { required: true, message: t('rolePlaceholder'), trigger: 'blur' },
...
,
    is_new: [
        { required: true, message: t('isNewPlaceholder'), trigger: 'blur' },
...
const confirm = async (formEl: FormInstance | undefined) => {
    ...
    let save = formData.id ? editMsg : addMsg
...
const setFormData = async (row: any = null) => {
    ...
    loading.value = true
    if(row){
        const data = await (await getMsgInfo(row.id)).data
