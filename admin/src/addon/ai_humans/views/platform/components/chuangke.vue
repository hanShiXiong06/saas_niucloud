<template>
  <el-dialog v-model="showDialog" title="创客API" width="680px" :destroy-on-close="true">
    <el-form :model="formData" label-width="140px" ref="formRef" :rules="formRules" class="page-form"
      ...
      <el-form-item label="通道" prop="channel">
        <el-radio-group v-model="formData.channel">
          <el-radio label="fast">V1极速通道</el-radio>
          <el-radio label="v3">V3专业通道</el-radio>
          <div>V1极速通道无主动查询接口,合成可能中断</div>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="快速导航">
        <el-button>
          <a href="https://api.hihookeji.com/user/register?cps=VYZ9EEEo" target="_blank">开放平台</a>
        </el-button>
      </el-form-item>
    </el-form>
