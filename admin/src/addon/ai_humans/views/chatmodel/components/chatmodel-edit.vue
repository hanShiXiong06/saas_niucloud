<template>
    <el-dialog v-model="showDialog" :title="formData.id ? t('updateChatModel') : t('addChatModel')" width="50%" class="diy-dialog-wrap" :destroy-on-close="true">
        <el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form" v-loading="loading">
                ...
                <el-form-item :label="t('demo')" >
                    <el-input v-model="formData.demo" clearable :placeholder="t('demoPlaceholder')" class="input-width" />
                </el-form-item>
...
import { addChatModel, editChatModel, getChatModelInfo } from '@/addon/ai_humans/api/chatmodel'
...
,
    demo: [
        { required: true, message: t('demoPlaceholder'), trigger: 'blur' },
...
const confirm = async (formEl: FormInstance | undefined) => {
    ...
    let save = formData.id ? editChatModel : addChatModel
...
const setFormData = async (row: any = null) => {
    ...
    loading.value = true
    if(row){
        const data = await (await getChatModelInfo(row.id)).data
