<template>
    <div class="main-container">
        <el-card class="box-card !border-none" shadow="never">
            ...
            <div class="mt-[10px]">
                <el-table :data="orderTable.data" size="large" v-loading="orderTable.loading">
                    ...
                    <el-table-column :show-overflow-tooltip="true" :label="t('wayInfo')" align="left" min-width="200">
        ...
        <export-sure ref="exportSureDialog" :show="flag" type="tourism_way_order" :searchParam="orderTable.searchParam" @close="handleClose" />
    </div>
</template>
...
import { t } from '@/lang'
import { getWayOrderList, getWayOrderStatus } from '@/addon/tourism/api/tourism'
...
const orderTable = reactive<IOrderTable>({
    page: 1,
    limit: 10,
    total: 0,
    loading: true,
...
const infoEvent = (info: AnyObject) => {
    router.push(`/tourism/order/way/detail?order_id=${info.order_id}`)
}
// 重置
