        ...
        <el-card class="box-card !border-none" shadow="never">
            ...
            <div class="mt-[10px]">
                <el-table :data="helpTable.data" size="large" v-loading="helpTable.loading">
                    ...
                    <el-table-column prop="content" :label="t('content')" min-width="120"
...
import { getHelpList, deleteHelp } from '@/addon/hk/api/help'
import { img } from '@/utils/common'
import { ElMessageBox, FormInstance } from 'element-plus'
import Edit from '@/addon/hk/views/help/components/help-edit.vue'
