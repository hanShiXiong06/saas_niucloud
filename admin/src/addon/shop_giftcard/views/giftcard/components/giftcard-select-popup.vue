<template>
    <div>
        ...
        <el-dialog v-model="showDialog" :title="t('giftcardSelectPopupSelectGiftcardDialog')" width="1000px" :destroy-on-close="true" :close-on-click-modal="false" @close="closeDialog">
