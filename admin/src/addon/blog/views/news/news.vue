<template>
    <div class="main-container">
        <el-card class="box-card !border-none" shadow="never">
            ...
            <edit ref="editNewsDialog" @complete="loadNewsList" />
        </el-card>
    </div>
</template>
...
import Edit from '@/addon/blog/views/news/components/news-edit.vue'
...
const editNewsDialog: Record<string, any> | null = ref(null)

/**
 * 添加微信社群
 */
const addEvent = () => {
    editNewsDialog.value.setFormData()
    editNewsDialog.value.showDialog = true
}
...
const editEvent = (data: any) => {
    editNewsDialog.value.setFormData(data)
    editNewsDialog.value.showDialog = true
}
