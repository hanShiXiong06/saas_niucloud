        ...
        <el-row :gutter="60">
          <el-col :span="19">
            <div class="flex items-end">
              ...
              <div class="bg-primary h-[45px] flex items-center px-[20px] rounded-[10px] ml-[10px] text-[#fff] cursor-pointer" @click="handelVerify">
                <span>{{ t("write") }}</span>
              </div>
              <div class="bg-primary h-[45px] flex items-center px-[20px] rounded-[10px] ml-[10px] text-[#fff] cursor-pointer" @click="toBlankLink('/vipcard/order/verify')">
            ...
            <div class="mt-[40px]">
              ...
              <el-row :gutter="15">
                ...
                <el-col :span="6">
                  <div class="w-full py-[20px] flex items-center border-[#E6E6E6] border-[1px] cursor-pointer" @click="toLink('/vipcard/goods/technician/list')">
                    <div class="ml-[18px] mr-[21px]">
          ...
          <el-col :span="5">
            ...
            <div>
              <div class="reserve-item min-w-[200px] h-[90px] pt-[18px] w-full cursor-pointer" @click="toLink('/vipcard/order/reserve')">
              ...
              <div class="refund-item min-w-[200px] h-[90px] pt-[18px] mt-[18px] w-full cursor-pointer" @click="toLink('/vipcard/order/refund')">
                <p class="ml-[16px] text-[14px] text-[#fff]">
                  {{ t("refundSales") }}
                </p>
                <p class="ml-[16px] text-[30px] text-[#fff]">
              ...
              <div class="service-item min-w-[200px] h-[90px] pt-[18px] mt-[18px] w-full cursor-pointer" @click="toLink('/vipcard/order/list')">
                <p class="ml-[16px] text-[14px] text-[#fff]">
                  {{ t("serviceFollow") }}
                </p>
                <p class="ml-[16px] text-[30px] text-[#fff]">
