<template>
    <div>
        <el-dialog v-model="showDialog" :title="t('cardSpreadTitle')" width="500px" :destroy-on-close="true">
...
const show = (data: any) => {
    ...
    page.value = `/addon/vipcard/pages/card/detail?id=${service.goods_id}`
    loadQrcode()
