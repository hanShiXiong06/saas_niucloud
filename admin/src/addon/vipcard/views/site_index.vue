				...
				<el-row :gutter="60">
					<el-col :span="19">
						<div class="flex items-end">
							...
							<div class="bg-primary h-[45px] flex items-center px-[20px] rounded-[10px] ml-[10px] text-[#fff] cursor-pointer"
								@click="toBlankLink('/order/vipcard/verify')">
							...
							<el-row :gutter="15">
								<el-col :span="6">
									<div class="w-full py-[20px] flex items-center border-[#E6E6E6] border-[1px] cursor-pointer"
										@click="toLink('/order/vipcard/index')">
										<div class="ml-[18px] mr-[21px]"><img class="min-w-[45px] h-[45px] max-w-[45px]"
												src="@/addon/vipcard/assets/images/reserve.png" /></div>
								...
								<el-col :span="6">
									<div class="w-full py-[20px] flex items-center border-[#E6E6E6] border-[1px] cursor-pointer"
										@click="toLink('/vipcard/service/list')">
										<div class="ml-[18px] mr-[21px]"><img class="min-w-[45px] h-[45px] max-w-[45px]"
												src="@/addon/vipcard/assets/images/service.png" /></div>
										<div class="flex flex-wrap">
								...
								<el-col :span="6">
									<div class="w-full py-[20px] flex items-center border-[#E6E6E6] border-[1px] cursor-pointer"
										@click="toLink('/vipcard/technician/list')">
										<div class="ml-[18px] mr-[21px]"><img class="min-w-[45px] h-[45px] max-w-[45px]"
												src="@/addon/vipcard/assets/images/member.png" /></div>
										<div class="flex flex-wrap">
								...
								<el-col :span="6">
									<div class="w-full py-[20px] flex items-center border-[#E6E6E6] border-[1px] cursor-pointer"
										@click="toLink('/vipcard/card/list')">
										<div class="ml-[18px] mr-[21px]"><img class="min-w-[45px] h-[45px] max-w-[45px]"
												src="@/addon/vipcard/assets/images/money.png" /></div>
										<div class="flex flex-wrap">
							...
							<el-row :gutter="30">
								...
								<el-col :span="12">
									<div class="w-full py-[16px] px-[20px] border-[#E6E6E6] border-[1px]">
										...
										<div class="my-[20px]">
											<div class="flex justify-center"><span class="text-[14px]">{{ t('accumulateMoney') }}</span></div>
											<div class="flex justify-center"><span class="text-[28px]">{{statTotal.buy_service_money }}</span></div>
										</div>
										<div class="flex justify-between">
							...
							<el-row :gutter="30" class="mt-[35px]">
								...
								<el-col :span="12">
									<div class="w-full py-[16px] px-[20px] border-[#E6E6E6] border-[1px]">
										...
										<div class="my-[20px]">
											<div class="flex justify-center"><span class="text-[14px]">{{t('accumulateMoney') }}</span></div>
											<div class="flex justify-center"><span class="text-[28px]">{{statTotal.buy_card_money }}</span></div>
										</div>
										<div class="flex justify-between">
						...
						<div class="py-[16px] px-[20px] border-[1px] border-[#E6E6E6] mt-[35PX]">
							...
							<el-row class="mt-[20px]">
								...
								<el-col :span="6">
									<div>
										<div class="flex justify-center items-center"><span class="text-[14px]">{{t('reserveNum') }}</span></div>
										<div class="flex justify-center items-center mt-[10px]"><span class="text-[28px]">{{statTotal.reserve_num }}</span></div>
										<!-- <div class="flex justify-center items-center mt-[20px]">
								...
								<el-col :span="6">
									<div>
										<div class="flex justify-center items-center"><span class="text-[14px]">{{t('cardNum') }}</span></div>
										<div class="flex justify-center items-center mt-[10px]"><span class="text-[28px]">{{statTotal.buy_card_num }}</span></div>
										<!-- <div class="flex justify-center items-center mt-[20px]">
					...
					<el-col :span="5">
						...
						<div>
							<div class="reserve-item min-w-[200px] h-[90px] pt-[18px] w-full cursor-pointer"
								@click="toLink('/order/vipcard/index')">
								<p class="ml-[16px] text-[14px] text-[#fff]">{{ t('reserveHandle') }}</p>
								<p class="ml-[16px] text-[30px] text-[#fff]">{{ statTotal.reserve_num }}</p>
							</div>
							...
							<div class="refund-item min-w-[200px] h-[90px] pt-[18px] mt-[18px] w-full cursor-pointer"
								@click="toLink('/order/vipcard/refund')">
								<p class="ml-[16px] text-[14px] text-[#fff]">{{ t("refundSales") }}</p>
								<p class="ml-[16px] text-[30px] text-[#fff]">{{ statTotal.refund_num }}</p>
							</div>
							...
							<div class="service-item min-w-[200px] h-[90px] pt-[18px] mt-[18px] w-full cursor-pointer"
								@click="toLink('/order/vipcard/order')">
								<p class="ml-[16px] text-[14px] text-[#fff]">{{ t('serviceFollow') }}</p>
								<p class="ml-[16px] text-[30px] text-[#fff]">{{ statTotal.buy_service_num }}</p>
							</div>
						</div>
					</el-col>
				</el-row>
		...
		<el-dialog v-model="showDialog" :title="title || t('verifyInfo')" width="500px" :destroy-on-close="true">
			...
			<el-form :model="formData" label-width="110px" ref="formRef" class="page-form"
				...
				<el-form-item :label="t('serviceImg')" v-if="verifyInfo.goods_type == 'service'">
					<img v-if="verifyInfo.cover_thumb_samll" :src="img(verifyInfo.cover_thumb_samll)" />
				</el-form-item>
...
import { ref } from 'vue'
import { t } from '@/lang'
import { getStat, getYesterdayStat, getTodayStat, getMonthStat, getVerifyDetail, verify } from '@/addon/vipcard/api/vipcard'
import { ElMessage } from 'element-plus'
import { img } from '@/utils/common'
import { useRouter } from 'vue-router'

const loading = ref(false)
const statYesterday = ref<any>([])
const statToday = ref<any>([])
const statMonth = ref<any>([])
