<template>
    <el-dialog v-model="showDialog" :title="formData.order_id ? t('updateOrder') : t('addOrder')" width="50%" class="diy-dialog-wrap" :destroy-on-close="true">
        <el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form" v-loading="loading">
                ...
                <el-form-item :label="t('examMoney')" prop="exam_money">
                    <el-input v-model="formData.exam_money" clearable :placeholder="t('examMoneyPlaceholder')" class="input-width" />
                </el-form-item>
...
import { addOrder, editOrder, getOrderInfo } from '@/addon/zzexam/api/exam'
...
,
    exam_money: [
        { required: true, message: t('examMoneyPlaceholder'), trigger: 'blur' },
