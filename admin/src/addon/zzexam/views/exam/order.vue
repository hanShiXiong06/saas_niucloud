        ...
        <el-card class="box-card !border-none" shadow="never">
            ...
            <div class="mt-[10px]">
                <el-table :data="orderTable.data" size="large" v-loading="orderTable.loading">
                    ...
                    <el-table-column prop="exam_title" :label="t('examTitle')" min-width="320" :show-overflow-tooltip="true"/>
...
import { getOrderList, deleteOrder } from '@/addon/zzexam/api/exam'
import { img } from '@/utils/common'
import { ElMessageBox,FormInstance } from 'element-plus'
import Edit from '@/addon/zzexam/views/exam/components/order-edit.vue'
