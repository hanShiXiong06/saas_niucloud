<template>
    <el-dialog v-model="showDialog" :title="formData.id ? t('updateErrors') : t('addErrors')" width="50%" class="diy-dialog-wrap" :destroy-on-close="true">
...
import { addErrors, editErrors, getErrorsInfo } from '@/addon/zzexam/api/study'
...
const confirm = async (formEl: FormInstance | undefined) => {
    ...
    let save = formData.id ? editErrors : addErrors
...
const setFormData = async (row: any = null) => {
    ...
    loading.value = true
    if(row){
        const data = await (await getErrorsInfo(row.id)).data
