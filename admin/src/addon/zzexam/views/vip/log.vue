            ...
            <el-card class="box-card !border-none my-[10px] table-search-wrap" shadow="never">
                <el-form :inline="true" :model="logTable.searchParam" ref="searchFormRef">
                    <el-form-item :label="t('mainType')" prop="main_type">
                        <el-input v-model="logTable.searchParam.main_type" :placeholder="t('mainTypePlaceholder')" />
                    </el-form-item>
                    <el-form-item :label="t('type')" prop="type">
                        <el-input v-model="logTable.searchParam.type" :placeholder="t('typePlaceholder')" />
                    </el-form-item>
                    <el-form-item :label="t('createTime')" prop="create_time">
                        <el-date-picker v-model="logTable.searchParam.create_time" type="datetimerange" format="YYYY-MM-DD hh:mm:ss"
...
import { getLogList, deleteLog } from '@/addon/zzexam/api/vip'
import { img } from '@/utils/common'
import { ElMessageBox,FormInstance } from 'element-plus'
import Edit from '@/addon/zzexam/views/vip/components/log-edit.vue'
