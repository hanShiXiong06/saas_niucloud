            ...
            <el-card class="box-card !border-none my-[10px] table-search-wrap" shadow="never">
                <el-form :inline="true" :model="vipTable.searchParam" ref="searchFormRef">
                    ...
                    <el-form-item class="w-[240px]" :label="t('status')" prop="status">
						<el-select v-model="vipTable.searchParam.status" filterable clearable :placeholder="t('statusPlaceholder')">
						   <el-option
...
import { getVipList, deleteVip } from '@/addon/zzexam/api/vip'
import { img } from '@/utils/common'
import { ElMessageBox,FormInstance } from 'element-plus'
import Edit from '@/addon/zzexam/views/vip/components/vip-edit.vue'
