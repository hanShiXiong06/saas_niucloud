    ...
    <div class="main-container">
        <el-card class="box-card !border-none" shadow="never">
            ...
            <div class="flex justify-between items-center">
                ...
                <el-button type="primary" class="w-[100px]" @click="dialogVisible = true">{{ t('addTemplate') }}</el-button>
            </div>

            <el-card class="box-card !border-none my-[10px] table-search-wrap" shadow="never">
                <el-form :inline="true" :model="posterTableData.searchParam" ref="searchFormDiyPosterRef">
                    <el-form-item :label="t('templateName')" prop="name">
                        <el-input v-model.trim="posterTableData.searchParam.name" :placeholder="t('templateNamePlaceholder')" />
                    </el-form-item>
            ...
            <el-table :data="posterTableData.data" size="large" v-loading="posterTableData.loading">
                ...
                <el-table-column prop="name" :label="t('templateName')" min-width="120" />
        ...
        <!--添加海报-->
        <el-dialog v-model="dialogVisible" :title="t('addTemplate')" width="350px">

            <el-form :model="formData" label-width="90px" ref="formRef" :rules="formRules">
                <el-form-item :label="t('templateName')" prop="name">
                    <el-input v-model.trim="formData.name" :placeholder="t('templateNamePlaceholder')" clearable maxlength="12" show-word-limit class="w-full" />
                </el-form-item>
            </el-form>
