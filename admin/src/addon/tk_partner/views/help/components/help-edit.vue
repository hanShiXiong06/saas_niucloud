<template>
    <el-dialog v-model="showDialog" :title="formData.id ? t('updateHelp') : t('addHelp')" width="50%" class="diy-dialog-wrap" :destroy-on-close="true">
        <el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form" v-loading="loading">

                
                <!-- <el-form-item :label="t('catId')" >
                    <el-select class="input-width" v-model="formData.cat_id" clearable :placeholder="t('catIdPlaceholder')">
                ...
                <el-form-item :label="t('viewNum')" >
                    <el-input-number v-model="formData.view_num" clearable :placeholder="t('viewNumPlaceholder')"  class="input-width"  :min = "0" max = "100" />
                </el-form-item>
...
import { addHelp, editHelp, getHelpInfo, getWithHelpCatList } from '@/addon/tk_partner/api/help'
