<template>
    <el-dialog v-model="showDialog" :title="formData.id ? t('updateCard') : t('addCard')" width="50%"
        class="diy-dialog-wrap" :destroy-on-close="true">
        <el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form"
            v-loading="loading">


            <el-form-item :label="t('cardNum')">
                <el-input disabled v-model="formData.card_num" clearable :placeholder="t('cardNumPlaceholder')"
                    class="input-width" />
            </el-form-item>

            <el-form-item :label="t('isUse')">

                <el-radio-group v-model="formData.is_use" class="ml-4">
...
import { addCard, editCard, getCardInfo, getWithLevelList } from '@/addon/tk_partner/api/card'
