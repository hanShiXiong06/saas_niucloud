<template>
	...
	<div class="content-wrap" v-show="diyStore.editTab == 'content'">
        ...
        <div class="edit-attr-item-wrap">
			<h3 class="mb-[10px]">店铺信息</h3>
            <span class="text-[18rpx] text-gray-400">这里是默认店铺信息</span>
			<el-form label-width="100px" class="px-[10px]" @submit.prevent>

                <el-form-item label="店铺名称">
                    <el-input v-model.trim="diyStore.editComponent.search.subTitle.text" placeholder="请输入店铺名称" clearable maxlength="10" show-word-limit />
				</el-form-item>
                
                <el-form-item label="店铺描述">
                    <el-input v-model.trim="diyStore.editComponent.search.subTitle.desc" placeholder="请输入店铺描述" clearable maxlength="10" show-word-limit />
				</el-form-item>
